...
import { Route as AuthenticatedApplayoutCoursesRouteImport } from './routes/_authenticated/_applayout/courses'
...
const AuthenticatedApplayoutCoursesRoute =
  AuthenticatedApplayoutCoursesRouteImport.update({
    id: '/courses',
    path: '/courses',
...
export interface FileRoutesByFullPath {
  ...
  '/courses': typeof AuthenticatedApplayoutCoursesRoute
...
export interface FileRoutesById {
  ...
  '/_authenticated/_applayout/courses': typeof AuthenticatedApplayoutCoursesRoute
  '/_authenticated/_applayout/_admin/admin-dashboard': typeof AuthenticatedApplayoutAdminAdminDashboardRoute
}
export interface FileRouteTypes {
  fileRoutesByFullPath: FileRoutesByFullPath
  fullPaths: '/' | '/login' | '/signup' | '/courses' | '/admin-dashboard'
  fileRoutesByTo: FileRoutesByTo
  to: '/' | '/login' | '/signup' | '/courses' | '/admin-dashboard'
  id:
    | '__root__'
    | '/'
    | '/_authenticated'
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_authenticated/_applayout/courses': {
      ...
      path: '/courses'
      fullPath: '/courses'
      preLoaderRoute: typeof AuthenticatedApplayoutCoursesRouteImport
...
interface AuthenticatedApplayoutRouteChildren {
  ...
  AuthenticatedApplayoutCoursesRoute: typeof AuthenticatedApplayoutCoursesRoute
}
...
const AuthenticatedApplayoutRouteChildren: AuthenticatedApplayoutRouteChildren =
  {
    ...
    AuthenticatedApplayoutCoursesRoute: AuthenticatedApplayoutCoursesRoute,
  }
