...
export interface ApiCourseSectionCourseSection
  ...
  attributes: {
    content_items: Schema.Attribute.DynamicZone<
      ['courses.lesson', 'courses.quiz']
    >;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    academic_experiences: Schema.Attribute.Component<
    ...
    > &
      Schema.Attribute.Private;
    motivations: Schema.Attribute.Blocks;
    password: Schema.Attribute.Password &
      Schema.Attribute.Private &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 6;
      }>;
    professional_experiences: Schema.Attribute.Component<
